<h2> 79 1
3142. Check if Grid Satisfies Conditions</h2><hr><div><p>You are given a 2D matrix <code>grid</code> of size <code>m x n</code>. You need to check if each cell <code>grid[i][j]</code> is:</p>
